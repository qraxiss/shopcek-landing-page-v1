                ...
                >
                    <div className="swiper-wrapper">
                        <SwiperSlide className="swiper-slide">
                            ...
                            <hr />
                            <div className="text">
                                Beginning with a strong merchandise foundation, expanding into digital sales and integrating blockchain technology to
                        ...
                        <SwiperSlide className="swiper-slide">
                            ...
                            <hr />
                            <div className="text">
                                Earn big with our SHPC token airdrop! Collect XP through various activities in the platform and convert them into SHPC
                                tokens. Start earning today!
                            </div>
                        </SwiperSlide>
                    </div>
